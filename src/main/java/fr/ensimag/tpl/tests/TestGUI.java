...
/**
 * Test de la librairie d'interface graphique. Permet de vérifier que tout fonctionne.
 */
public class TestGUI {
	/**
	 * Méthode principale du test, dessine des rectangles dans une fenêtre.
	 *
	 * @param args Argumetns passés en ligne de commande.
	 */
